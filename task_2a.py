    ...
    * ArUco_corners = 
    ...
    if ids is not None:
        for i in range(len(ids)):
            ...
            angle = int(math.degrees(math.atan2(marker_corners[1][1] - marker_corners[0][1], marker_corners[1][0] - marker_corners[0][0])))

            ArUco_details_dict[marker_id] = [center_coordinates, angle]
